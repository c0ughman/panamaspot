...
HUBS = {
 "el-valle-de-anton": dict(
  ...
  groups=[
   ...
   dict(t="Planning the visit", img=IMG+"elvalle-town.webp",
        alt="Avenida Central in El Valle de Antón, with the crater rim behind the shopfronts",
        blurb="How long to give it, where to sleep if you stay, and how it compares with the other mountain town.",
        items=[("/articles/el-valle-de-anton-itinerary-one-day","El Valle in One Day","What actually fits between the first bus in and the last one out."),
               ("/articles/where-to-stay-in-el-valle-de-anton","Where to Stay","The crater floor, the rim and the outskirts — what each costs and suits."),
               ("/articles/el-valle-de-anton-vs-boquete","El Valle or Boquete?","Two highland towns compared on climate, cost, hiking and how long to stay.")]),
  ...
  index=[("/articles/things-to-do-el-valle-de-anton","Things to Do in El Valle de Antón","Overview"),
         ...
         ("/articles/el-valle-de-anton-itinerary-one-day","El Valle de Antón in One Day","Planning"),
         ("/articles/where-to-stay-in-el-valle-de-anton","Where to Stay in El Valle de Antón","Planning"),
         ("/articles/el-valle-de-anton-vs-boquete","El Valle de Antón vs Boquete","Comparison")],
 ),
 "boquete": dict(
  ...
  groups=[
   ...
   dict(t="Coffee, cloud forest and birds", img=BQIMG+"boquete-losquetzales.webp",
        ...
        items=[("/articles/boquete-coffee-farm-tour","Coffee Farm Tours","Which estate to pick, what a tour actually covers, and what the Geisha fuss is about."),
               ...
               ("/articles/quetzal-season-boquete-when-where-to-see-resplendent-quetzal","Quetzal Season","Which months, which hours, which trees — and what a guide is actually for.")]),
   dict(t="Hot water, rivers and tours", img=BQIMG+"boquete-river2.webp",
        ...
        items=[("/articles/caldera-hot-springs-boquete","Caldera Hot Springs","The thermal pools down the valley — fees, temperatures and the road in."),
               ("/articles/boquete-hot-springs-caldera-vs-los-pozos","Caldera vs Los Pozos","Two sets of thermal pools a few kilometres apart, honestly compared."),
               ("/articles/tours-in-boquete-panama","Tours, Bikes and Prices","Guided options and rentals, with what each one costs in 2026.")]),
   dict(t="On two wheels", img=BQIMG+"boquete-ebike-trail.webp",
        alt="Two riders on a dirt track through the coffee above Boquete",
        blurb="The valley roads climb hard and the scenery pays for it. A motor turns a brutal day into a good one.",
        items=[("/articles/boquete-bike-rental","Bike and E-Bike Rental","Prices, what is included, and which shops are worth the money."),
               ("/articles/boquete-cycling-routes","Five Rides Out of Town","Bajo Mono, Volcancito, Caldera, Palo Alto and the Jaramillo climb, with gradients.")]),
   dict(t="Planning: when to come, where to sleep", img=BQIMG+"boquete-cabins.webp",
        alt="Timber A-frame cabins on a hillside above Boquete, hydrangeas along the wall",
        blurb="Boquete has real seasons and four quite different neighbourhoods. Both decisions change the trip.",
        items=[("/articles/best-time-to-visit-boquete","Best Time to Visit","Month by month, including what the bajareque actually does to a day."),
               ("/articles/where-to-stay-in-boquete","Where to Stay","Bajo Boquete, Jaramillo, Alto Quiel and Volcancito — walkability, climate and cost."),
               ("/articles/panama-city-to-boquete","Getting There from Panama City","Bus, flight via David, or driving — real costs and door-to-door times.")])],
  ...
  index=[("/articles/things-to-do-in-boquete-panama","Things to Do in Boquete, Panama","Overview"),
         ...
         ("/articles/quetzal-season-boquete-when-where-to-see-resplendent-quetzal","Quetzal Season in Boquete","Birding"),
         ("/articles/best-time-to-visit-boquete","Best Time to Visit Boquete","Planning"),
         ("/articles/where-to-stay-in-boquete","Where to Stay in Boquete","Planning"),
         ("/articles/panama-city-to-boquete","Panama City to Boquete","Getting there"),
         ("/articles/boquete-bike-rental","Boquete Bike Rental","Cycling"),
         ("/articles/boquete-cycling-routes","Boquete Cycling Routes","Cycling"),
         ("/articles/boquete-hot-springs-caldera-vs-los-pozos","Caldera vs Los Pozos de Caldera","Hot springs"),
 ...
 "es-el-valle-de-anton": dict(
  ...
  groups=[
   ...
   dict(t="Familia, animales y aventura", img=IMG+"elvalle-flowermarket.webp",
        ...
        items=[("/es/articles/zoologico-el-nispero-el-valle-de-anton","Zoológico El Níspero","La rana dorada, el mariposario y qué tanto rinde con niños pequeños."),
               ...
               ("/es/articles/mariposario-el-valle-de-anton","Mariposario y serpentario","Mariposas vivas y el serpentario contiguo: horarios, precios y qué se ve."),
               ("/es/articles/tours-en-bicicleta-el-valle-de-anton","Tours en bicicleta","E-bikes y bicicletas normales: precios, rutas y qué operador elegir.")]),
   dict(t="Comer, dormir y el mercado", img=IMG+"elvalle-flowermarket.webp",
        alt="Puestos de plantas y flores bajo el techo del mercado de El Valle de Antón",
        blurb="Dónde comer bien sin pagar de más, dónde quedarse si te quedas a dormir, y el mercado que abre todos los días.",
        items=[("/es/articles/mercado-el-valle-de-anton","Mercado de El Valle","Días, horarios y qué se consigue de verdad en el mercado artesanal."),
               ("/es/articles/donde-comer-en-el-valle-de-anton","Dónde comer","De fondas a restaurantes: precios reales y cuáles valen el desvío."),
               ("/es/articles/donde-dormir-el-valle-de-anton","Dónde dormir","Hospedajes por zona y presupuesto, del hostal a las cabañas del cráter.")]),
   dict(t="Planificar: llegar, precios y horarios", img=IMG+"elvalle-town.webp",
        alt="La Avenida Central de El Valle de Antón, con el borde del cráter al fondo",
        blurb="Lo práctico: cómo llegar en bus desde la capital, y cuánto cuesta cada cosa antes de salir.",
        items=[("/es/articles/bus-albrook-el-valle-de-anton-horarios-precios","Bus desde Albrook","Horarios, precios y cuánto tarda de verdad la terminal de Albrook a El Valle."),
               ("/es/articles/precios-horarios-el-valle-de-anton","Precios y horarios","Entradas, transporte y horarios de cada atracción, en una sola tabla."),
               ("/es/articles/chorro-las-mozas-pozas-el-valle-de-anton","Chorro Las Mozas","Las pozas del río: cómo llegar, cuándo hay agua y qué cobran."),
               ("/es/articles/piedra-pintada-el-valle-de-anton","La Piedra Pintada","Los petroglifos, la caminata corta hasta ellos y qué se sabe de su origen.")])],
  cta=dict(img=IMG+"evbike-bike-crater.webp", eyebrow="E-Valley Bikes · El Valle",
  ...
  index=[("/es/articles/que-hacer-el-valle-de-anton","Qué Hacer en El Valle de Antón","General"),
         ("/es/articles/bus-albrook-el-valle-de-anton-horarios-precios","Bus Albrook a El Valle de Antón","Cómo llegar"),
         ("/es/articles/precios-horarios-el-valle-de-anton","Precios y Horarios El Valle de Antón","Planificar"),
         ("/es/articles/donde-dormir-el-valle-de-anton","Dónde Dormir en El Valle de Antón","Dormir"),
         ("/es/articles/donde-comer-en-el-valle-de-anton","Dónde Comer en El Valle de Antón","Comer"),
         ("/es/articles/mercado-el-valle-de-anton","Mercado de El Valle de Antón","Mercado"),
         ("/es/articles/mariposario-el-valle-de-anton","Mariposario El Valle de Antón","Familia"),
         ("/es/articles/piedra-pintada-el-valle-de-anton","La Piedra Pintada","Cultura"),
         ("/es/articles/chorro-las-mozas-pozas-el-valle-de-anton","Chorro Las Mozas","Cascadas"),
         ("/es/articles/tours-en-bicicleta-el-valle-de-anton","Tours en Bicicleta El Valle de Antón","Tours"),
 ...
 "es-boquete": dict(
  ...
  groups=[
   ...
   dict(t="Planificar: cuándo venir y cuánto cuesta", img=BQIMG+"boquete-cabins.webp",
        alt="Cabañas de madera a dos aguas en una ladera de Boquete, con hortensias al frente",
        blurb="Boquete tiene temporadas de verdad y precios que se pueden calcular antes de salir.",
        items=[("/es/articles/cuanto-cuesta-boquete-presupuesto-semana","¿Cuánto cuesta Boquete?","Presupuesto real de una semana: transporte, hospedaje, comida y tours."),
               ("/es/articles/el-volcan-baru-esta-activo","¿El Barú está activo?","Qué dice la ciencia, quién lo monitorea y los riesgos reales de subir.")]),
   dict(t="En familia, flores y jardines", img=BQIMG+"boquete-flowers2.webp",
        alt="Macizos de dalias bajo los pinos en un jardín de Boquete",
        blurb="El lado tranquilo del pueblo: la feria de enero, los jardines y qué hacer con niños.",
        items=[("/es/articles/boquete-con-ninos-guia-familiar","Boquete con niños","Actividades por edad, senderos seguros y qué NO es apto para ellos."),
               ("/es/articles/feria-de-las-flores-y-del-cafe-boquete","Feria de las Flores y del Café","Fechas, entradas, cómo llegar y dónde dormir en la semana más llena del año."),
               ("/es/articles/mi-jardin-es-su-jardin-boquete","Mi Jardín es Su Jardín","El jardín de Don Lalo, su estado actual y los otros jardines del pueblo.")])],
  cta=dict(img=BQIMG+"boquete-ebike-hero.webp", eyebrow="E-Valley Bikes · Boquete",
  ...
  index=[("/es/articles/que-hacer-en-boquete-guia-completa","Qué Hacer en Boquete","General"),
         ("/es/articles/cuanto-cuesta-boquete-presupuesto-semana","¿Cuánto cuesta Boquete?","Presupuesto"),
         ("/es/articles/boquete-con-ninos-guia-familiar","Boquete con Niños","Familia"),
         ("/es/articles/feria-de-las-flores-y-del-cafe-boquete","Feria de las Flores y del Café","Eventos"),
         ("/es/articles/mi-jardin-es-su-jardin-boquete","Mi Jardín es Su Jardín","Jardines"),
         ("/es/articles/el-volcan-baru-esta-activo","¿El Volcán Barú está activo?","Volcán"),
